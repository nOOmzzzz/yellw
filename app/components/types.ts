...
export const FLOWER_OPTIONS: FlowerMeta[] = [
  ...
  },
  {
    ...
    symbolism: 'Símbolo de alegría luminosa, calidez y el renacer más fino de la primavera.',
    accentColor: '#fde047',
  ...
  },
  {
    ...
    symbolism: 'Símbolo del sol de primavera, vitalidad radiante y buenos deseos.',
    accentColor: '#fbbf24',
  ...
  },
  {
    ...
    symbolism: 'Inocencia, espontaneidad, frescura y la magia de los nuevos comienzos.',
    accentColor: '#fef08a',
